...
public static class QuizContextSeeding
{
    ...
    private static async Task Seed(QuizDbContext context)
    {
        ...
        quizzes[0].Add(Question.Create(new Description("What planet is known as the Red Planet?"), new QuestionNumber(1), quizzes[1].Id));
        quizzes[0].Add(Question.Create(new Description("What is the symbol for water?"), new QuestionNumber(2), quizzes[1].Id));

        quizzes[0].Add(Question.Create(new Description("Who was the first President of the United States?"), new QuestionNumber(1), quizzes[2].Id));
        quizzes[0].Add(Question.Create(new Description("When was the Declaration of Independence signed?"), new QuestionNumber(2), quizzes[2].Id));
